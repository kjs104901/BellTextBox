...
public struct LineCoordinates : IEquatable<LineCoordinates>
{
    ...
    public LineCoordinates FindCoordinates(CaretMove caretMove)
    {
        ...
        if (CaretMove.Right == caretMove)
        {
            ...
            {
                // Check end of file
                if (Singleton.LineManager.GetLine(newCoordinates.Line.Index + 1, out Line nextLine))
                {
        ...
        else if (CaretMove.Left == caretMove)
        {
            ...
            {
                // Check start of file
                if (Singleton.LineManager.GetLine(newCoordinates.Line.Index - 1, out Line prevLine))
                {
